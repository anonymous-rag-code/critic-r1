...
# -----------------------------
num_questions = 10000
# HotpotQA dev distractor split for evaluation
hotpot_json_path = "hotpot_dev_distractor_v1.json"
...
def main():
    ...
    output_csv_path = f"hotpotqa_dev_inference_results_{args.suffix}.csv"
    ...
    questions, golden_answers = load_questions_from_hotpot_json(
